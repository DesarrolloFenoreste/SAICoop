 ...
 * @author prometeo
 */
@XmlRootElement(name = "JPersonasBloqueadasTempDTO")
public class JPersonasBloqueadasTempDTO implements Serializable {
...
ALTER TABLE j_personasbloqueadas_temp
  OWNER TO postgres;
COMMENT ON TABLE j_personasbloqueadas_temp
  IS 'en esta tabla que es temporal se encuantran las personas bloqueadas';
    ...
    public JPersonasBloqueadasTempDTO(String id_doc, String nombre, String rfc, String curp, Integer idod, String fecha, Object fecha_alta_saicoop, String dato1, String dato2, String dato3) {
        this.id_doc = id_doc;
        this.nombre = nombre;
        this.rfc = rfc;
        this.curp = curp;
    ...
    public JPersonasBloqueadasTempDTO() {
    }
    ...
    public boolean equals(Object obj) {
        ...
        final JPersonasBloqueadasTempDTO other = (JPersonasBloqueadasTempDTO) obj;
